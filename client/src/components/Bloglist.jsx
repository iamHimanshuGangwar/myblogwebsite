    ...
    return (
        <div className='w-full px-4 sm:px-8 xl:px-20'>
            ...
            <div className='mb-8 text-center sm:text-left mt-10'>
                <h2 className='text-3xl font-extrabold flex items-center justify-center sm:justify-start gap-3'>
                ...
                {/* Sub text bold + improved readability */}
                <p className='mt-2 text-gray-600 dark:text-gray-400 font-semibold tracking-wide'>
